...
export default class NavBar extends React.Component {
  ...
  render() {
    ...
    }, "NavBar: github(", /* Only when appModes have "split-table" */id ? /*#__PURE__*/React.createElement("a", {
    ...
    }, "List"), ") | Ref tables: (", this.renderReferenceTableLink(), ") |", ' ', /*#__PURE__*/React.createElement("a", {
      title: "GitHub File Path",
      href: githubDb.getDataUrl(dbName, tableName),
      target: "_blank",
      rel: "noreferrer"
    }, githubDb.getDataPath(dbName, tableName)), "(", /*#__PURE__*/React.createElement("a", {
