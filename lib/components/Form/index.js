  ...
  constructor(props) {
    ...
    _defineProperty(this, "renderStringArrayFormField", column => {
      ...
      if (!column['type:createUpdatePage'] || column['type:createUpdatePage'] === 'Select') {
        ...
        }, /*#__PURE__*/React.createElement("b", null, column.name), ":", ' ', (column.quickOptions || []).map(opt => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
          key: opt,
          size: "small",
          onClick: () => {
            this.handleStringArrayChange(column.id)([...(this.state.formValues[column.id] || []), opt]);
          }
        }, opt), ' ')), ' ', /*#__PURE__*/React.createElement(Select, {
          size: "small",
          mode: "tags",
          style: {
            width: '100%'
