...
export { default as MultipleInputs } from './components/MultipleInputs';
...
export { default as UpdatePage } from './components/UpdatePage'; // contexts

export * as contexts from './contexts/page'; // ddRender

export * as ddRender from './ddRender/ddRender'; // layout
...
export { default as Table } from './layout/Table'; // pages
