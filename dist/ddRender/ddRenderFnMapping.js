...
Handlebars.registerHelper('getTableRecordByKey', options => {
  ...
  const primaryKey = getTablePrimaryKey(options.hash.tables, options.hash.tableName);
 ...
 */
const genRenderFunc = Component => function dComponent(val, record, index, args, tplExtra) {
...
//# sourceMappingURL=ddRenderFnMapping.js.map