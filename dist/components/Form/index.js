...
export default class Form extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "handleInputChange", key => (val /* ,event */) => {
      ...
      if (!this.isSplitTable) {
        ...
        if (key === this.context.primaryKey) {
          if (!validatePrimaryKey(val, this.props.rows, this.context.primaryKey)) {
    ...
    _defineProperty(this, "renderStringArrayFormField", column => {
      ...
      if (!column['type:createUpdatePage'] || column['type:createUpdatePage'] === 'Select') {
        return /*#__PURE__*/React.createElement("div", {
          ...
          column: column,
          onChange: val => {
            this.handleStringArrayChange(column.id)([...(this.state.formValues[column.id] || []), val]);
          }
